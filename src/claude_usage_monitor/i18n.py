...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "rate_limited": "Trop de requêtes — réessai auto…",
    ...
    "de": {
        ...
        "rate_limited": "Zu viele Anfragen — automatischer Neuversuch…",
    ...
    "es": {
        ...
        "rate_limited": "Demasiadas solicitudes — reintento automático…",
    ...
    "pt": {
        ...
        "rate_limited": "Muitas solicitações — tentativa automática…",
    ...
    "it": {
        ...
        "rate_limited": "Troppe richieste — ritentativo automatico…",
